...
func (_m *AWSResourceReconciler) SecretValueFromReference(_a0 string, _a1 *corev1.SecretKeySelector) (string, error) {
	ret := _m.Called(_a0, _a1)

	var r0 string
	if rf, ok := ret.Get(0).(func(string, *corev1.SecretKeySelector) string); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(string)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, *corev1.SecretKeySelector) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
