...
func (rm *resourceManager) sdkCreate(
	...
	_, respErr := rm.sdkapi.CreateDBClusterParameterGroupWithContext(ctx, input)
	if respErr != nil {
		return nil, respErr
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) sdkUpdate(
	...
	_, respErr := rm.sdkapi.ModifyDBClusterParameterGroupWithContext(ctx, input)
	if respErr != nil {
		return nil, respErr
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) sdkDelete(
	...
	_, respErr := rm.sdkapi.DeleteDBClusterParameterGroupWithContext(ctx, input)
	return respErr
}
